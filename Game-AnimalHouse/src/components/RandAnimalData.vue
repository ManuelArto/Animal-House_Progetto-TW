<template>
	...
	<b>Dati</b>
	<ol>
		<li>The latin name is <b>{{ animal.latin_name }}</b></li>
		<li>The type of this animal is <b>{{ animal.animal_type }}</b></li>
		<li>The active time of the animal is <b>{{ animal.active_time }}</b></li>
