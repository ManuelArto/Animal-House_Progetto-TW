            ...
            <div class="flex flex-wrap ">
                ...
                <div class="lg:w-1/2 pr-4 pl-4">
                    <div class="mb-4 focused">
                        ...
                        <label class="absolute right-32 form-control-label" for="gender-input">
                            Sesso
                        </label>
                        <br>
                        <select class="form-select border-gray-300 rounded-xl" id="weight-input">
                        ...
                        <select class="form-select border-gray-300 rounded-xl" id="gender-input">
